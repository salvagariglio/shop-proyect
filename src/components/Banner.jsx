            ...
            <div className="w-screen h-[650px] relative">
                ...
                >
                    <img
                        ...
                        loading="priority"
                    />
                    <img className="w-full h-full object-cover" src={BackgroundImage2} alt="Image2" />
                    <img className="w-full h-full object-cover" src={BackgroundImage3} alt="Image3" />
                    <img className="w-full h-full object-cover" src={BackgroundImage4} alt="Image4" />
                </div>
